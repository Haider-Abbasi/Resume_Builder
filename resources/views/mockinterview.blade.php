            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 col-md-12">
                        ...
                        <!-- <a href="/mockinterview/create" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft">Create</a> -->
                        <!-- <a href="/mockinterview/view" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">View</a> -->
                        <a href="/mockinterview/search" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">Search</a>
