...
<head>
    <meta charset="utf-8">
    <title>Career Catalyst Index admin</title>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <a href="{{ route('resume.builder') }}" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">Upload CV</a> -->
                    ...
                    <a href="manageusers"
                        class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">Manage
                        Users</a>
                    <a href="searchmiadmin"
                        class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">Manage
                        Mock Questions</a>
        ...
        <div class="container d-flex justify-content-center">
            <div class="row">
                <div class="col-md-12 text-center">
                    <span class="text-light"><a href="#" style="text-decoration: none; color: inherit;"><i
                                class="fas fa-copyright text-light me-2"></i>Career Catalyst</a>, All rights
                        reserved.</span>
                </div>
            </div>
        </div>
